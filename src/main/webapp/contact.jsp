                        ...
                        <div class="col-xl-6 col-lg-6 col-md-8 col-sm-6">
                            <div class="headerinfo">
                                <ul>
                                    ...
                                    <li class="d-none d-md-inline-block"><a href="#"><i class="fal fa-map-marker-alt"></i>13/A, New Hawk Tower, NYC</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-10 col-lg-9 col-md-4 col-4 d-flex align-items-center justify-content-end">
                            ...
                            <div class="header-cta">
                                ...
                                <div class="phone-number">
                                    ...
                                    <p><a href="tel:+897-985-564-45">992345678</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12 col-md-4 col-sm-6">
                                <div class="tp-contact-info mb-40">
                                    ...
                                    <div class="tp-contact-info-text">
                                        ...
                                        <p><a href="#">CLOCK TOWER ROAD<br>palace ST , AP</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-4 col-sm-6">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <p class="mb-30 copy-right-text-1">design & copyright by <a href="#">@JABFARMS</a> - 2024</p>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
